    ...
    if 'ads_data' in st.session_state:
        new_pages = {
            "": [
                ...
                st.Page("tools/2_gold.py", title="G.O.L.D.", icon="✨"),
                st.Page("tools/3_rankings.py", title="Rankings", icon="⭐"),
                st.Page("tools/4_matrix.py", title="Matrix", icon="💊"),
                st.Page("tools/5_image_analyzer.py", title="Image Analyzer", icon="🔍"),
