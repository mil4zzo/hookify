...
# Edição do período do pack (plano de edição de período): muda o que o pack É.
ACTION_PACK_DATE_RANGE = "pack.date_range"
...
_KNOWN_ACTIONS = frozenset({
    ...
    ACTION_PACK_RENAME, ACTION_PACK_DELETE, ACTION_PACK_SHEET_COLUMNS, ACTION_PACK_DATE_RANGE,
