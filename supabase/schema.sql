...
\restrict 9Xb3LgYV5n1UxK5VivhovIzdetGxbbdjMiac1zQdcZdd0lQPtlekBbdq2h37H4k
...
COMMENT ON FUNCTION public.fetch_manager_rankings_core_v2(p_user_id uuid, p_date_start date, p_date_stop date, p_group_by text, p_pack_ids uuid[], p_account_ids text[], p_campaign_name_contains text, p_adset_name_contains text, p_ad_name_contains text, p_action_type text, p_include_leadscore boolean, p_include_available_conversion_types boolean, p_limit integer, p_offset integer, p_order_by text, p_campaign_id text) IS 'Manager core v2 wrapper: resolve o effective_status de campanha/conjunto a partir de parent_entities (migration 122), enriquece linhas de adset/campanha com budget e ad_count do inventario. Base: fetch_manager_performance_base_v132 (migration 132). Rollback: reaplicar a migration 130 (v130) ou a 122 (v116).';
...
\unrestrict 9Xb3LgYV5n1UxK5VivhovIzdetGxbbdjMiac1zQdcZdd0lQPtlekBbdq2h37H4k
