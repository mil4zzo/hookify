...
\restrict h630XhICItR1A2v1jcPm9wDwk8vOQmTQbdDuDx9feBGQ9P4rk5Mn5A5yBJ9s01S
...
COMMENT ON FUNCTION public.batch_update_ad_metrics_enrichment(p_user_id uuid, p_updates jsonb, p_pack_id uuid) IS 'Atualiza multiplos registros de ad_metrics em uma unica transacao via UPDATE + CTE, aplicando apenas leadscore_values (fluxo Leadscore-only). Aceita p_pack_id opcional para restringir as metricas cujo pack_ids contem esse pack.';
...
--
-- Name: ad_metrics_pack_ids_gin; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ad_metrics_pack_ids_gin ON public.ad_metrics USING gin (pack_ids);
...
\unrestrict h630XhICItR1A2v1jcPm9wDwk8vOQmTQbdDuDx9feBGQ9P4rk5Mn5A5yBJ9s01S
