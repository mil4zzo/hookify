...
\restrict 9QG8Ig2FFzCdUHBnaix9cP7fZeLWLme98ApUPcUVX4sSs7aydjfb8ISBgG6QsEr
...
COMMENT ON FUNCTION public.ad_pack_inventory_backfill(p_user_id uuid) IS 'F5: preenche ad_pack_inventory a partir das linhas-zero sintéticas de ad_metrics (sem as anteriores à criação do anúncio). Idempotente. Uso administrativo (migration e laboratório).';
...
\unrestrict 9QG8Ig2FFzCdUHBnaix9cP7fZeLWLme98ApUPcUVX4sSs7aydjfb8ISBgG6QsEr
