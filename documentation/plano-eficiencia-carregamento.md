...
| **F7** | Refresh grava em `ads` só o que mudou: anúncios, vínculo com o pack (migration 153), transcrições e miniaturas (§4-bis) | ~meio dia | −15 a −20 s num refresh grande; ~−90% dos ~12 GB de escrita a cada 18 dias; mantém o ganho da 152 | baixo | 🚢 **no ar desde 14/09** — confirmar ganho em 24 h |
