...
> o sync do Leadscore com a credencial do dono (P3.3b-planilha) e as ESCRITAS de
> entidade do convidado (status/budget/status-sync — P3.3b-resto parcial). Próximo:
> **testar com o time real** (10+ commits acumulados, nada em produção ainda);
> depois P3.5 (log de ações). P3.3b-resto está concluída.
