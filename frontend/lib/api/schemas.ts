...
export const StatusSyncResponseSchema = z.object({
  ...
  // Idem para conjuntos/campanhas (parent_entities: status + orçamento).
  changed_parents: z.number().optional(),
})
...
const RankingsSeriesSchema = z.object({
  ...
  video_watched_p75: z.array(z.number().nullable()).optional(),
  plays: z.array(z.number().nullable()).optional(),
  thruplays: z.array(z.number().nullable()).optional(),
  reach: z.array(z.number().nullable()).optional(),
...
export const RankingsItemSchema = z.object({
  ...
  video_watched_p75: z.number().optional(),
...
export const RankingsChildrenItemSchema = z.object({
  ...
  lpv: z.number(),
  plays: z.number(),
  video_total_thruplays: z.number().optional(),
  hook: z.number(),
  hold_rate: z.number().optional(),
  video_watched_p50: z.number().optional(),
  video_watched_p75: z.number().optional(),
