      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          {jobProgress.status === "completed" && jobProgress.data && (
            <div className="mt-4 p-4 bg-success-20 border border-border rounded-lg">
              <p className="text-sm text-success font-medium">✅ {jobProgress.message}</p>
            </div>
          )}

          {/* Status de erro */}
          {(jobProgress.status === "failed" || jobProgress.status === "error") && (
            <div className="mt-4 p-4 bg-destructive-20 border border-border rounded-lg">
              <p className="text-sm text-destructive font-medium">❌ {jobProgress.message}</p>
            </div>
          )}
