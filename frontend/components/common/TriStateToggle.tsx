  ...
  return (
    ...
    >
      <button
        ...
        className={cn(
          "relative inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors focus-inset focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
