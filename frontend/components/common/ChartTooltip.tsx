...
export function ChartTooltip({ title, value, className = "", titleClassName = "", valueClassName = "", style }: ChartTooltipProps) {
  return (
    <div
      className={`absolute px-2 py-1 bg-popover text-popover-foreground text-xs rounded-sm shadow-elevation-overlay whitespace-nowrap z-20 pointer-events-none ${className}`}
      style={style}
    >
