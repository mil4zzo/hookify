    ...
    <aside className={cn("hidden md:flex fixed left-0 top-0 h-screen bg-sidebar text-sidebar-foreground border-r border-border backdrop-blur supports-[backdrop-filter]:bg-background-60 z-sticky flex-col transition-all duration-300 overflow-hidden", isCollapsed ? "w-16 ease-in" : "w-64 ease-out")}>
      ...
      <nav className={cn("px-3 transition-all duration-300", isCollapsed ? "px-2 ease-in" : "ease-out")}>
        <ul className="space-y-1">
          {getMenuItems(userTier).map((item) => {
            ...
            return (
              <li key={item.path}>
                <Link href={item.path as any} className={cn("flex items-center rounded-md text-sm font-normal text-foreground transition-all duration-300", isCollapsed ? "justify-center px-2 py-2 ease-in" : "gap-3 px-3 py-2 ease-out", isActive ? "bg-primary text-foreground" : "text-foreground hover:bg-input-30 hover:text-foreground")} title={isCollapsed ? item.label : undefined}>
      ...
      <div className="mt-auto border-t border-border">
        <div className={cn("px-3 py-4 space-y-1 transition-all duration-300", isCollapsed ? "px-2 ease-in" : "ease-out")}>
          <Link href="/docs" className={cn("flex items-center rounded-md text-xs font-normal text-foreground transition-all duration-300", isCollapsed ? "justify-center px-2 py-2 ease-in" : "gap-2 px-3 py-2 ease-out", pathname === "/docs" ? "bg-primary text-foreground" : "text-foreground hover:bg-input-30 hover:text-foreground")} title={isCollapsed ? "Docs" : undefined}>
