...
export default function ServerStatusBanner() {
  ...
  if (showOnlineFeedback && status === "online") {
    return (
      <div className="w-full bg-success-20 border-b border-success-50 py-2">
      ...
      <div className="hidden md:flex container mx-auto items-center justify-between px-8">
        <div className="flex items-center gap-2 text-destructive min-w-0">
          ...
          <span className="text-sm font-medium truncate">
            Servidor offline
            {lastOnlineAt && (
              <span className="text-destructive-70 ml-2 font-normal">
                (última conexão há{" "}
        ...
        <div className="flex items-center gap-2 shrink-0">
          <Button variant="outline" size="sm" onClick={() => refetch()} disabled={isChecking} className="h-7 text-xs border-destructive-50 text-destructive hover:bg-destructive-30">
            {isChecking ? (
              <>
