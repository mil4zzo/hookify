  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        <Button variant="outline" role="combobox" aria-expanded={open} size={size} className={cn("control-lit w-full items-center justify-between rounded-md border border-surface-3 bg-input px-3 py-2 text-sm placeholder:text-muted-foreground hover:border-border focus:outline-none focus:border-primary disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1", className)}>
