...
export function KanbanCard({ ad, metricLabel, variant = "success", rank, secondaryText, selected = false, onClick }: KanbanCardProps) {
  ...
  return (
    <StandardCard
      ...
      interactive={true}
      onClick={onClick}
      className={cn(styles.border, styles.bg, selected && "ring-2 ring-primary-20 border-primary bg-primary-10")}
    >
      <div className="p-1">
        <div className="flex items-start gap-3">
          {/* Thumbnail */}
          <div className="relative w-24 h-24 flex-shrink-0 rounded-sm overflow-hidden bg-border">
