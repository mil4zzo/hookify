...
/**
 * Ícone oficial do Meta (Facebook)
 *
 * @example
 * <MetaIcon className="w-6 h-6" />
 */
export const MetaIcon: ComponentType<MetaIconProps> = ({ className = "", size = 24 }) => {
  // Calcular proporção do viewBox original (290x191) para manter aspect ratio
  const aspectRatio = 290 / 191;
  const height = size / aspectRatio;

  return (
    <svg className={className} width={size} height={height} viewBox="0 0 290 191" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" aria-label="Meta">
      <defs>
