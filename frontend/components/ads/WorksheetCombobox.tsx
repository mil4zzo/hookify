  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button variant="picker" role="combobox" aria-expanded={open} disabled={disabled || !spreadsheetId} className={cn("h-control-default w-full items-center justify-between rounded-md px-3 py-2 text-sm placeholder:text-muted-foreground focus-inset focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1", className)}>
